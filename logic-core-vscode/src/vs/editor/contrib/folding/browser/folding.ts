...
class FoldAllBlockCommentsAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('foldAllBlockComments.label', "折叠所有块注释"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllRegionsAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('foldAllMarkerRegions.label', "折叠所有区域"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllRegionsAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('unfoldAllMarkerRegions.label', "展开所有区域"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllExceptAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('foldAllExcept.label', "折叠所有除选中项"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllExceptAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('unfoldAllExcept.label', "展开所有除选中项"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			id: 'editor.foldAll',
			label: nls.localize2('foldAllAction.label', "折叠全部"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			id: 'editor.unfoldAll',
			label: nls.localize2('unfoldAllAction.label', "展开全部"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
