	...
	constructor() {
		super(false, {
			...
			menuOpts: {
				...
				group: '2_line',
				title: nls.localize({ key: 'miCopyLinesUp', comment: ['&& denotes a mnemonic'] }, "向上复制行(&&C)"),
				order: 1
			},
	...
	constructor() {
		super(true, {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miCopyLinesDown', comment: ['&& denotes a mnemonic'] }, "向下复制行(&&P)"),
				order: 2
			},
			canTriggerInlineEdits: true,
		});
...
export class DuplicateSelectionAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('duplicateSelection', "复制选区"),
			precondition: EditorContextKeys.writable,
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miDuplicateSelection', comment: ['&& denotes a mnemonic'] }, "复制选区(&&D)"),
				order: 5
			},
			canTriggerInlineEdits: true,
		});
	...
	constructor() {
		super(false, {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miMoveLinesUp', comment: ['&& denotes a mnemonic'] }, "向上移动行(&&V)"),
				order: 3
			},
			canTriggerInlineEdits: true,
		});
	...
	constructor() {
		super(true, {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miMoveLinesDown', comment: ['&& denotes a mnemonic'] }, "向下移动行(&&L)"),
				order: 4
			},
			canTriggerInlineEdits: true,
		});
...
export class SortLinesAscendingAction extends AbstractSortLinesAction {
	constructor() {
		super(false, {
			...
			label: nls.localize2('lines.sortAscending', "升序排列行"),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true,
		});
	}
...
export class SortLinesDescendingAction extends AbstractSortLinesAction {
	constructor() {
		super(true, {
			...
			label: nls.localize2('lines.sortDescending', "降序排列行"),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true,
		});
	}
...
export class TrimTrailingWhitespaceAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('lines.trimTrailingWhitespace', "修剪尾随空格"),
			precondition: EditorContextKeys.writable,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineBeforeAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('lines.insertBefore', "在上方插入行"),
			precondition: EditorContextKeys.writable,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineAfterAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('lines.insertAfter', "在下方插入行"),
			precondition: EditorContextKeys.writable,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
export class TransposeAction extends EditorAction {
	constructor() {
		super({
			...
			label: nls.localize2('editor.transpose', "转置字符"),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true,
		});
	}
