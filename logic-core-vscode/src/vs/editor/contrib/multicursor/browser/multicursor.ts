...
export class InsertCursorAbove extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('mutlicursor.insertAbove', "在上方添加光标"),
			...
			menuOpts: {
				...
				group: '3_multi',
				title: nls.localize({ key: 'miInsertCursorAbove', comment: ['&& denotes a mnemonic'] }, "在上方添加光标(&&A)"),
				order: 2
			}
		});
	}
...
export class InsertCursorBelow extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('mutlicursor.insertBelow', "在下方添加光标"),
			precondition: undefined,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miInsertCursorBelow', comment: ['&& denotes a mnemonic'] }, "在下方添加光标(&&D)"),
				order: 3
			}
		});
	}
	...
	constructor() {
		super({
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miInsertCursorAtEndOfEachLineSelected', comment: ['&& denotes a mnemonic'] }, "将光标添加到行尾(&&U)"),
				order: 4
			}
		});
	}
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('mutlicursor.addCursorsToBottom', "将光标添加到底部"),
			precondition: undefined
		});
	}
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('mutlicursor.addCursorsToTop', "将光标添加到顶部"),
			precondition: undefined
		});
	}
...
export class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('addSelectionToNextFindMatch', "将选区添加到下一个查找匹配"),
			precondition: undefined,
			kbOpts: {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miAddSelectionToNextFindMatch', comment: ['&& denotes a mnemonic'] }, "添加下一个匹配项(&&N)"),
				order: 5
			}
		});
	}
...
export class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('addSelectionToPreviousFindMatch', "将选区添加到上一个查找匹配"),
			precondition: undefined,
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miAddSelectionToPreviousFindMatch', comment: ['&& denotes a mnemonic'] }, "添加上一个匹配项(&&P)"),
				order: 6
			}
		});
	}
	...
	constructor() {
		super({
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miSelectHighlights', comment: ['&& denotes a mnemonic'] }, "选择所有匹配项(&&O)"),
				order: 7
			}
		});
	}
...
export class CompatChangeAll extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('changeAll.label', "更改所有出现项"),
