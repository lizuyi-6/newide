	...
	constructor() {
		super(Type.Toggle, {
			...
			menuOpts: {
				...
				group: '5_insert',
				title: nls.localize({ key: 'miToggleLineComment', comment: ['&& denotes a mnemonic'] }, "切换行注释(&&T)"),
				order: 1
			},
	...
	constructor() {
		super({
			...
			menuOpts: {
				menuId: MenuId.MenubarEditMenu,
				group: '5_insert',
				title: nls.localize({ key: 'miToggleBlockComment', comment: ['&& denotes a mnemonic'] }, "切换块注释(&&B)"),
				order: 2
			},
			canTriggerInlineEdits: true,
		});
