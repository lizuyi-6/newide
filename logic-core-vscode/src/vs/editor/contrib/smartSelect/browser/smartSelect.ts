...
class GrowSelectionAction extends AbstractSmartSelect {
	constructor() {
		super(true, {
			...
			label: nls.localize2('smartSelect.expand', "扩大选区"),
			...
			menuOpts: {
				...
				group: '1_basic',
				title: nls.localize({ key: 'miSmartSelectGrow', comment: ['&& denotes a mnemonic'] }, "扩大选区(&&E)"),
				order: 2
			}
		});
	}
...
class ShrinkSelectionAction extends AbstractSmartSelect {
	constructor() {
		super(false, {
			...
			label: nls.localize2('smartSelect.shrink', "缩小选区"),
			precondition: undefined,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '1_basic',
				title: nls.localize({ key: 'miSmartSelectShrink', comment: ['&& denotes a mnemonic'] }, "缩小选区(&&S)"),
				order: 3
			}
		});
	}
