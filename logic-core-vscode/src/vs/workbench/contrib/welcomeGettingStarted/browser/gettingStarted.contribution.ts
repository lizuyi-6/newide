...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			metadata: {
				description: localize2('minWelcomeDescription', '打开入门指南以帮助您开始使用 VS Code。')
			}
		});
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('welcome.showAllWalkthroughs', '打开入门指南...'),
			category,
			f1: true,
			menu: {
				id: MenuId.MenubarHelpMenu,
	...
	async run(accessor: ServicesAccessor) {
		...
		quickPick.placeholder = localize('pickWalkthroughs', '选择要打开的入门指南');
	...
	properties: {
		...
		'workbench.startupEditor': {
			...
			'enumDescriptions': [
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.welcomePage' }, "打开欢迎页面，其中包含帮助您开始使用 VS Code 和扩展的内容。"),
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.readme' }, "如果文件夹包含 README，则打开它，否则回退到 'welcomePage'。注意：这仅作为全局配置观察，如果在工作区或文件夹配置中设置，它将被忽略。"),
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.newUntitledFile' }, "打开一个新的无标题文本文件 (仅适用于打开空窗口时)。"),
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.terminal' }, "在编辑器区域通过打开一个新的终端。"),
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.agentSessionsWelcomePage' }, "打开代理会话欢迎页面。"),
			],
			'default': 'welcomePage',
			'description': localize('workbench.startupEditor', "控制启动时显示的编辑器，如果没有从上一次会话恢复。")
		},
		'workbench.welcomePage.preferReducedMotion': {
			...
			description: localize('workbench.welcomePage.preferReducedMotion', "如果启用，减少欢迎页面中的动画。")
		}
	}
});
