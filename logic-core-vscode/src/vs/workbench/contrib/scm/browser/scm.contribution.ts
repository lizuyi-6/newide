...
viewsRegistry.registerViews([{
	...
	openCommandActionDescriptor: {
		id: viewContainer.id,
		mnemonicTitle: localize({ key: 'miViewSCM', comment: ['&& denotes a mnemonic'] }, "源代码管理(&&C)"),
		keybindings: {
			primary: 0,
...
viewsRegistry.registerViews([{
	...
	containerTitle,
	name: localize2('scmGraph', "图表"),
	singleViewPaneContainerTitle: localize('source control graph', "源代码管理图表"),
