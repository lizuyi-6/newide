...
export const STEP_OVER_LABEL = nls.localize2('stepOverDebug', "单步跳过");
export const STEP_INTO_LABEL = nls.localize2('stepIntoDebug', "单步进入");
export const STEP_INTO_TARGET_LABEL = nls.localize2('stepIntoTargetDebug', "单步进入目标");
export const STEP_OUT_LABEL = nls.localize2('stepOutDebug', "单步跳出");
export const PAUSE_LABEL = nls.localize2('pauseDebug', "暂停");
export const DISCONNECT_LABEL = nls.localize2('disconnect', "断开连接");
export const DISCONNECT_AND_SUSPEND_LABEL = nls.localize2('disconnectSuspend', "Disconnect and Suspend");
export const STOP_LABEL = nls.localize2('stop', "停止");
export const CONTINUE_LABEL = nls.localize2('continueDebug', "继续");
export const FOCUS_SESSION_LABEL = nls.localize2('focusSession', "Focus Session");
export const SELECT_AND_START_LABEL = nls.localize2('selectAndStartDebugging', "选择并开始调试");
export const DEBUG_CONFIGURE_LABEL = nls.localize('openLaunchJson', "Open '{0}'", 'launch.json');
export const DEBUG_START_LABEL = nls.localize2('startDebug', "开始调试");
