...
class ToggleWordWrapAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('toggle.wordwrap', "视图: 切换自动换行"),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		id: TOGGLE_WORD_WRAP_ID,
		title: nls.localize('unwrapMinified', "禁用此文件的自动换行"),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		id: TOGGLE_WORD_WRAP_ID,
		title: nls.localize('wrapMinified', "启用此文件的自动换行"),
		icon: Codicon.wordWrap
	},
	group: 'navigation',
	order: 1,
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	command: {
		id: TOGGLE_WORD_WRAP_ID,
		title: nls.localize({ key: 'miToggleWordWrap', comment: ['&& denotes a mnemonic'] }, "自动换行(&&W)"),
