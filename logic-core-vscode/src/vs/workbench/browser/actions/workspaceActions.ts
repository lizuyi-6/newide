...
const workspacesCategory: ILocalizedString = localize2('workspaces', '工作区');
...
export class OpenFolderAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openFolder', '打开文件夹...'),
			category: Categories.File,
			f1: true,
...
export class OpenFileFolderAction extends Action2 {
	...
	static readonly LABEL: ILocalizedString = localize2('openFileFolder', '打开...');
...
class OpenWorkspaceAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openWorkspaceAction', '从文件打开工作区...'),
			category: Categories.File,
			f1: true,
...
class CloseWorkspaceAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('closeWorkspace', '关闭工作区'),
...
class OpenWorkspaceConfigFileAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openWorkspaceConfigFile', '打开工作区配置文件'),
			category: workspacesCategory,
			f1: true,
...
export class RemoveRootFolderAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('globalRemoveFolderFromWorkspace', '从工作区移除文件夹...'),
			category: workspacesCategory,
			f1: true,
...
class SaveWorkspaceAsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('saveWorkspaceAsAction', '将工作区另存为...'),
			category: workspacesCategory,
			f1: true,
			precondition: EnterMultiRootWorkspaceSupportContext
		});
...
class DuplicateWorkspaceInNewWindowAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('duplicateWorkspaceInNewWindow', '在新窗口中复制工作区'),
			category: workspacesCategory,
			f1: true,
			precondition: EnterMultiRootWorkspaceSupportContext
		});
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: OpenFileAction.ID,
		title: localize({ key: 'miOpenFile', comment: ['&& denotes a mnemonic'] }, "打开文件(&&O)...")
	},
	order: 1,
	when: IsMacNativeContext.toNegated()
});
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: OpenFolderAction.ID,
		title: localize({ key: 'miOpenFolder', comment: ['&& denotes a mnemonic'] }, "打开文件夹(&&F)...")
	},
	order: 2,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: OpenFileFolderAction.ID,
		title: localize({ key: 'miOpen', comment: ['&& denotes a mnemonic'] }, "打开(&&O)...")
	},
	order: 1,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: OpenWorkspaceAction.ID,
		title: localize({ key: 'miOpenWorkspace', comment: ['&& denotes a mnemonic'] }, "从文件打开工作区(&&K)...")
	},
	order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: localize({ key: 'miAddFolderToWorkspace', comment: ['&& denotes a mnemonic'] }, "将文件夹添加到工作区(&&D)...")
	},
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: SaveWorkspaceAsAction.ID,
		title: localize('miSaveWorkspaceAs', "将工作区另存为...")
	},
	order: 2,
	when: EnterMultiRootWorkspaceSupportContext
});
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: DuplicateWorkspaceInNewWindowAction.ID,
		title: localize('duplicateWorkspace', "复制工作区")
	},
	order: 3,
	when: EnterMultiRootWorkspaceSupportContext
});
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: CloseWorkspaceAction.ID,
		title: localize({ key: 'miCloseFolder', comment: ['&& denotes a mnemonic'] }, "关闭文件夹(&&F)")
	},
	order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		id: CloseWorkspaceAction.ID,
		title: localize({ key: 'miCloseWorkspace', comment: ['&& denotes a mnemonic'] }, "关闭工作区(&&W)")
	},
	order: 3,
