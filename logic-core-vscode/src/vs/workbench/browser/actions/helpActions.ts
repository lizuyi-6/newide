...
class KeybindingsReferenceAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				...localize2('keybindingsReference', "键盘快捷键参考"),
				mnemonicTitle: localize({ key: 'miKeyboardShortcuts', comment: ['&& denotes a mnemonic'] }, "键盘快捷键参考(&&K)"),
			},
...
class OpenYouTubeUrlAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				...localize2('openYouTubeUrl', "在YouTube上加入我们"),
				mnemonicTitle: localize({ key: 'miYouTube', comment: ['&& denotes a mnemonic'] }, "在YouTube上加入我们(&&J)"),
			},
			category: Categories.Help,
			f1: true,
			menu: {
