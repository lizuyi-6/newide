		...
		},
		{
			...
			children: [
				...
				},
				{
					...
					label: localize('breadcrumbs', "面包屑导航"),
					settings: ['breadcrumbs.*']
				},
				{
					id: 'workbench/editor',
					label: localize('editorManagement', "编辑器管理"),
		...
		},
		{
			...
			children: [
				...
				},
				{
					...
					label: localize('issueReporter', '问题报告器'),
		...
		},
		{
			...
			children: [
				...
				},
				{
					...
					label: localize('experimental', "实验性功能"),
